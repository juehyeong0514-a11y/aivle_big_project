  ...
  return (
    <section className="workspace-shell">
      ...
      <div className="workspace-heading">
        <div><h1>시험 생성</h1><p>시험 기본 정보와 일정을 설정하세요.</p></div>
      </div>
      ...
      <form className="data-panel form-panel create-exam-form" onSubmit={createExam}>
        ...
        <div className="form-row">
          <div className="duration-field">
            <div className="schedule-fieldset-heading"><strong>시험 시간</strong></div>
            <label className="duration-control" htmlFor="exam-duration">
              <span className="duration-control-label">분</span>
        ...
        <button className="primary-button" type="submit" disabled={!organizationId}><Plus size={17} /> 시험 만들기</button>
      </form>
    </section>
  );
}
